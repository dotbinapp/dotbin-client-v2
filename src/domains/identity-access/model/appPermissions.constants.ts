export const APP_PERMISSIONS = {
  ...
  DOCTORS_ADMIN: 'Permite crear y editar profesionales del centro.',
  DOCTORS_EDIT: 'Permite editar profesionales del centro.',
  DOCTORS_LIST_READ: 'Permite acceder a la gestión y consulta de profesionales del centro.',
  PATIENTS_ADMIN: 'Permite crear y editar pacientes.',
  PATIENTS_EDIT: 'Permite editar pacientes.',
