  ...
  return (
    ...
    >
      <span className="relative inline-flex size-9 items-center justify-center rounded-full">
        <img alt="Perfil de usuario" className="size-9 rounded-full object-cover ring-2 ring-ui-surface" src={PROFILE_AVATAR_SRC} />
        <span className="absolute -right-0.5 -bottom-0.5 size-3 rounded-full border-2 border-ui-surface bg-emerald-400" />
      </span>
    </MenuButton>
  )
}
